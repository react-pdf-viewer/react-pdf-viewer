...
const App = () => {
    const [fileUrl, setFileUrl] = React.useState<PdfJs.FileData>(
    ...
    return (
        <Worker workerUrl="https://unpkg.com/pdfjs-dist@2.7.570/build/pdf.worker.js">
            <div style={{ marginRight: '8px' }}>
                <button onClick={() => setFileUrl('sample.pdf')}>Load document 1</button>
                <button onClick={() => setFileUrl('pdf-open-parameters.pdf')}>Load document 2</button>
            </div>
            <div
                style={{
                    height: '720px',
