...
import OpenMenuItem, { OpenMenuItemProps } from './OpenMenuItem';
...
const openPlugin = (): OpenPlugin => {
    ...
    const OpenMenuItemDecorator = (props: OpenMenuItemProps) => (
        <OpenDecorator>
            {(p) => <OpenMenuItem onOpenFile={p.onClick} onClick={props.onClick} />}
        </OpenDecorator>
    );
